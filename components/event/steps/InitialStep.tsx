import { ChevronDownIcon, ChevronUpIcon, RightArrowCircleIcon } from "@/components/icons";
                ...
                >
                    ...
                    <Stack spacing="5px" width={'100%'} flex={1}>
                        <Stack
                            ...
                            width={'100%'}
                        >
                            <Typography variant="bodyMB" fontSize={'14px'} fontWeight={600}>Full Pass</Typography>
                            <Stack direction="row" alignItems="end" spacing="5px" sx={{ opacity: '0.7' }}>
                                <Typography variant="bodyMB">1000</Typography>
                                <Typography variant="caption">USDT</Typography>
                            </Stack>
                        </Stack>
                        <Typography variant="bodyS" fontSize={'13px'} fontWeight={400} sx={{ opacity: '0.7' }} fontFamily={'Inter'} lineHeight={'140%'} letterSpacing={'0.13px'}>
                ...
                >
                    ...
                    <Stack spacing="5px" width={'100%'} flex={1}>
                        <Stack
                            ...
                            direction="row"
                        >
                            <Typography variant="bodyMB" fontSize={'14px'} fontWeight={600}>Week Pass</Typography>
                            <Stack direction="row" alignItems="end" spacing="5px" sx={{ opacity: '0.7' }}>
                                <Typography variant="bodyMB">1000</Typography>
                                <Typography variant="caption">USDT</Typography>
                            </Stack>
