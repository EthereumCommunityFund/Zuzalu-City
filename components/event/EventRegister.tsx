    ...
    >
      ...
      >
        ...
        <Box display={'flex'} gap={'10px'} alignItems={'center'}>
          <Typography textTransform={'uppercase'} fontSize={'10px'} sx={{ opacity: '0.6' }}>
            Ticketing PROTOCOL:
          </Typography>
          <Box
            display={'flex'}
