...
export const definition = {
  models: {
    Event: {
      interface: false,
      implements: [],
      id: 'kjzl6hvfrbw6c7boclsl4y3mr9lm6ys0j7hafl6yb4q3mc91hbluo720fc2mmjk',
      accountRelation: { type: 'list' },
    },
    MVPProfile: {
      interface: false,
      implements: [],
      id: 'kjzl6hvfrbw6c66uig1mk220cq51ciqgxvcug0ydpoxthbh8qxmo6l47vvh35jm',
      accountRelation: { type: 'single' },
    },
    Session: {
      interface: false,
      implements: [],
      id: 'kjzl6hvfrbw6c5tb0keo5gx0hcytjz1n75fiucxs289fh4lsks7lfe5li9y5fje',
      accountRelation: { type: 'list' },
    },
    Space: {
      interface: false,
      implements: [],
      id: 'kjzl6hvfrbw6c84tttp6ntn4ngagd1fiff3ggh1fm75dvgiqsxstrozt7m578da',
      accountRelation: { type: 'list' },
    },
  },
  objects: {
    Event: {
      ...
      tracks: { type: 'string', required: false, immutable: false },
      update: {
        type: 'list',
        required: false,
        immutable: false,
      ...
      contractID: { type: 'integer', required: false, immutable: false },
      customLinks: {
        type: 'list',
        required: false,
        immutable: false,
      ...
      space: {
        ...
        relation: {
          source: 'document',
          model:
            'kjzl6hvfrbw6c84tttp6ntn4ngagd1fiff3ggh1fm75dvgiqsxstrozt7m578da',
          property: 'spaceId',
        },
      },
      ...
      profile: {
        ...
        relation: {
          source: 'document',
          model:
            'kjzl6hvfrbw6c66uig1mk220cq51ciqgxvcug0ydpoxthbh8qxmo6l47vvh35jm',
          property: 'profileId',
        },
      },
      sessions: {
        ...
        relation: {
          ...
          model:
            'kjzl6hvfrbw6c5tb0keo5gx0hcytjz1n75fiucxs289fh4lsks7lfe5li9y5fje',
          property: 'eventId',
        },
      },
    },
    ...
    EventTicket: {
      ...
      status: { type: 'string', required: true, immutable: false },
      image_url: { type: 'string', required: true, immutable: false },
    ...
    MVPProfile: {
      ...
      events: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c7boclsl4y3mr9lm6ys0j7hafl6yb4q3mc91hbluo720fc2mmjk',
          property: 'profileId',
        },
      },
      spaces: {
