...
export const definition = {
  models: {
    Event: {
      interface: false,
      implements: [],
      id: 'kjzl6hvfrbw6c60bb5siydwk3iyg6dav5gxee33ixwe2qt2ye5rgvvlos5js8gr',
    ...
    Session: {
      interface: false,
      implements: [],
      id: 'kjzl6hvfrbw6c50y9ne6latftzcmzir5j76q4p8dcnzxkqonogebjieszljmggo',
      accountRelation: { type: 'list' },
    },
    Space: {
      interface: false,
      implements: [],
      id: 'kjzl6hvfrbw6c96lu2u58syitpel0wrj25w9bq6pc6locv20i7rjyib1q088sen',
      accountRelation: { type: 'list' },
    },
  },
  objects: {
    Event: {
      ...
      space: {
        ...
        relation: {
          source: 'document',
          model:
            'kjzl6hvfrbw6c96lu2u58syitpel0wrj25w9bq6pc6locv20i7rjyib1q088sen',
          property: 'spaceId',
        },
      },
      ...
      sessions: {
        ...
        relation: {
          ...
          model:
            'kjzl6hvfrbw6c50y9ne6latftzcmzir5j76q4p8dcnzxkqonogebjieszljmggo',
          property: 'eventId',
        },
      },
    },
    ...
    EventZupass: { hash: { type: 'string', required: true, immutable: false } },
    MVPProfile: {
      ...
      events: {
        ...
        relation: {
          source: 'queryConnection',
          model:
            'kjzl6hvfrbw6c60bb5siydwk3iyg6dav5gxee33ixwe2qt2ye5rgvvlos5js8gr',
          property: 'profileId',
        },
      },
      spaces: {
