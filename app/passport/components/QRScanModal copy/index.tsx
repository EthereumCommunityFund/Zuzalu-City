      ...
      {isSuccess && (
        <div className="fixed overflow-y-auto top-1/2 left-1/2 transform -translate-x-1/2 md:-translate-y-1/2 w-fit">
          <div className="backdrop-blur-xl rounded-[10px] bg-[rgba(52,52,52,0.80)] border-2 border-[rgba(255,255,255,0.10)] relative p-5 shadow-lg">
            ...
            <div className="text-[#7DFFD1] mt-2.5 text-[18px] font-[700] text-center">
              Verified
            </div>
          </div>
        </div>
      ...
      {isFailed && (
        <div className="fixed overflow-y-auto top-1/2 left-1/2 transform -translate-x-1/2 md:-translate-y-1/2 w-fit">
          <div className="backdrop-blur-xl rounded-[10px] bg-[rgba(52,52,52,0.80)] border-2 border-[rgba(255,255,255,0.10)] relative p-5 shadow-lg">
            ...
            <div className="mb-3.5 text-[#FF5E5E] mt-2.5 text-[18px] font-[700] text-center">
              Unverified
            </div>

            <button
              onClick={() => handleReScan()}
              className="w-full px-[14px] py-[10px] rounded-[10px] font-[600] bg-[rgba(255,255,255,0.05)] text-white"
            >
              Re-Scan
            </button>
          </div>
