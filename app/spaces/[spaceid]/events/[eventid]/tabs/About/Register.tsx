...
import { ArrowDownTrayIcon, ArrowUpRightIcon, RightArrowIcon, ScrollIcon } from '@/components/icons';
    ...
    <Stack>
      <Stack padding="20px" bgcolor="#262626" borderBottom="1px solid #383838" spacing="20px">
        ...
        <Stack direction="row" spacing="14px">
          <Box component="img" width="140px" height="140px" borderRadius="8px" src="/24.webp" />
          <Stack spacing="10px">
      ...
      <Stack padding="20px" spacing="20px">
        <Stack padding="20px" border="1px solid #383838" bgcolor="#262626" spacing="30px" borderRadius="10px">
          ...
          <Stack paddingY="20px" bgcolor="#323232" borderRadius="10px">
            {awaiting && <Typography variant="subtitleS" fontWeight={400} textAlign="center" sx={{ opacity: 0.7 }}>
              Awaiting transaction...
            </Typography>}
            <Typography variant="subtitleS" fontWeight={400} textAlign="center" sx={{ opacity: 0.7 }}>
...
export const Payment: React.FC<IProps> = ({ setIsEmail, setIsPayment, handleClose }) => {
  return (
    <Stack>
      <Stack padding="20px" bgcolor="#262626" borderBottom="1px solid #383838" spacing="20px">
        <Stack direction="row" spacing="10px" alignItems="center">
        ...
        <Stack padding="20px" spacing="30px" borderRadius="10px" border="1px solid #383838" alignItems="center" bgcolor="#222222">
          <Typography variant="subtitleLB">
            Congrats, you received
          </Typography>
          <Box component="img" width="300px" height="300px" borderRadius="20px" src="/26.png" />
