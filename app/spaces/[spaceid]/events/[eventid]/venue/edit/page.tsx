...
export default function VenueEditPage() {
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <Typography fontSize={'14px'} color={'rgb(153, 153, 153)'} fontWeight={500}>
                            {"Monday, May 6, 2024"}
                        </Typography>
                    </Box>
                </Stack>
                ...
                >
                    {
                        optionButtons.map((button, index) => {
                            return (
                                <VenueOptionButton key={index} {...button} onClick={button.onClick} />
                            )
                        })
                    }
                </Stack>
                ...
                >
                    ...
                    >
                        {
                            MOCK_DATA.venueSessions.length > 0 ? MOCK_DATA.venueSessions.map((session: any, index) => (
            ...
            <PostAnnouncementModal showModal={showModal} setShowModal={setShowModal} />
        </Stack>
    )
}