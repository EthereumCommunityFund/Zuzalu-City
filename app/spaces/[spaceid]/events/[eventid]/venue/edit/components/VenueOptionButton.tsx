...
export const VenueOptionButton = ({ icon, content, description, onClick, ...props }: PropTypes) => {
    return (
        <Box
            {
                ...props
            ...
            sx={{
                ...
                '&::before': {
                    ...
                    width: '100%',
                    height: '100%',
                    background: 'linear-gradient(117deg, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0.05) 100%)',
