import { CopyIcon, GoToExplorerIcon, ScrollIcon, USDTIcon } from "@/components/icons";
        ...
        <Stack sx={{ background: "#222", height: "100%" }}>
            ...
            >
                ...
                >
                    ...
                    <Image style={{
                        width: '100%',
                        height: 'auto',
                    }} alt={"/24.webp"} src={"/24.webp"} width={100} height={100} />
            ...
            <Stack padding={"20px"}>
                <Box marginBottom={"20px"}>
                    <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", paddingBottom: "14px" }}>
                        <Typography
                            fontSize="14px"
                            fontFamily={"Inter"}
                            lineHeight={"160%"}
