            ...
            width:
              anchor === 'top' || anchor === 'bottom'
                ...
                : isMobile
                  ? '100%'
                  : '762px',
            minHeight: state.right ? 'auto' : '100vh',
              ...
              >
                ...
                >
                  ...
                  <Stack spacing="10px">
                    ...
                    <Typography variant="bodyS" sx={{ opacity: 0.6 }}>
                      Choose a type for your session to relay its nature to
                      guests
                    </Typography>
                    <ZuInput
                      value={sessionType}
                  ...
                  <Stack spacing="10px">
                    ...
                    <Select
                      ...
                      style={{ width: '100%' }}
                      onChange={(e) =>
                        setSessionExperienceLevel(e.target.value)
                      }
                      ...
                      {sessionLocation && (
                        <Stack spacing="20px">
                          <Stack spacing="10px">
                            ...
                            <Typography variant="bodyS">
                              View and select the available dates and times for
                              this location
                            </Typography>
                                    ...
                                    if (
                                      ...
                                      if (view === 'hours') {
                                        ...
                                        for (
                                          ...
                                          if (
                                            isTimeAvailable(checkTime, true)
                                          ) {
                                            availableMinutes += 5;
                                          }
                                        }
                                    ...
                                    if (
                                      ...
                                      if (view === 'hours') {
                                        for (
                                          ...
                                          if (
                                            isTimeAvailable(checkTime, false)
                                          ) {
                                            return false;
                                          }
                                        }
